    ...
    return {
      rest: {
        codespaces: {
          ...
          listInRepositoryForAuthenticatedUser: async ({ owner, repo }: { owner: string; repo: string }) => {
            if (this.shouldThrowOnList) {
              throw new Error('List failed');
            }
          ...
          getForAuthenticatedUser: async ({ codespace_name }: { codespace_name: string }) => {
          ...
          deleteForAuthenticatedUser: async ({ codespace_name }: { codespace_name: string }) => {
          ...
          startForAuthenticatedUser: async ({ codespace_name }: { codespace_name: string }) => {
          ...
          stopForAuthenticatedUser: async ({ codespace_name }: { codespace_name: string }) => {
...
Deno.test('GitHubRepositoryError constructor', () => {
  ...
  const error = new GitHubRepositoryError('Test message', 'testOperation', cause);
