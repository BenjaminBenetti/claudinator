...
Deno.test("Unit - AgentList should handle different selected indices", async () => {
  ...
  const component1 = TestRenderer.create(
    <AgentList {...mockProps} selectedIndex={0} focusArea={FocusArea.Sidebar} />
  );
  ...
  const component2 = TestRenderer.create(
    <AgentList {...mockProps} selectedIndex={1} focusArea={FocusArea.Sidebar} />
  );
  ...
  const component3 = TestRenderer.create(
    <AgentList {...mockProps} selectedIndex={mockAgents.length} focusArea={FocusArea.Sidebar} />
  );
